<header id="header" class="flex md:flex-col flex-row gap-2 bg-ceramic fixed left-0 md:w-80 w-full p-0 md:border-r md:h-full h-auto justify-between md:justify-start duration-500">
