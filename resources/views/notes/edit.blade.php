<x-self.template title="PM Notes" css="notes.css">
    <main class="w-full md:pl-80 pt-24 md:pt-4 pb-24 flex flex-col flex-wrap items-center relative z-10 full min-h-screen">
        ...
        <button id="updateBtn" class="w-32 h-32 flex justify-center items-center text-white font-bold text-xl absolute bottom-4 right-4" type="button" data-id="{{ $id }}">UPDATE</button>
    </main>
    <script>
        window.Laravel = {};
