<x-self.template title="PM Daily Report" css="reports.css">
    <main class="w-full md:pl-80 pt-24 md:pt-4 pb-24 flex flex-col flex-wrap items-center gap-4 relative z-10 full">
        ...
        <div class="w-full md:p-6 p-0 md:min-w-full min-w-[200dvw]">
            <div class="flex md:justify-end justify-start mb-4">
                <a href="{{ route('reports.add') }}" class="px-4 py-2 rounded-lg shadow bg-green-100 bg-opacity-70 hover:bg-green-200 duration-500 text-xl">New Report</a>
            </div>
            ...
            <div id="calendar" class="w-full h-[800px]">
